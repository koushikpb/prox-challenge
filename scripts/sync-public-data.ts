/*
 * Mirrors `data/pages` and `data/regions` into `public/data/` so that
 * Next.js serves them as ordinary static assets at the `/data/...` URLs
 * the agent tools (`get_page_image`, `get_region`) emit.
 *
